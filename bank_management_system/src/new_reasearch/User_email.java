...
public class User_email extends JFrame implements ActionListener{
	...
	public void sed_mail(){
		...
		try{
           ...
           transport.close();
           JOptionPane.showMessageDialog(null, "Message is successfull ");}
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource()==BTN_back){
			firstwindow_user back = new firstwindow_user();
