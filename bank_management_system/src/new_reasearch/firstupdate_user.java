...
public class firstupdate_user extends JFrame implements ActionListener{
	...
	public firstupdate_user(){
		...
		try {
			setContentPane(new JLabel(new ImageIcon(ImageIO.read(new File("C:\\Users\\Benayi\\workspace\\ReSearch\\c1.jpg")))));
		}
		catch(Exception e)
		{
